...
<body>
    ...
    <div class="card">
        <% 
            ...
            // 1. Preluam datele trimise de m1_Filme.jsp
            int aux = java.lang.Integer.parseInt(request.getParameter("id_film")); 
            ...
            // 2. Pregatim vectorii pentru functia generica
            String[] valori = {titlu, an_aparitie, durata, regizor}; 
            String[] campuri = {"titlu", "an_aparitie", "durata", "regizor"}; 
            
            // 3. Executam UPDATE-ul
            jb.modificaTabela("filme", "id_film", aux, campuri, valori); 
        ...
        <p>Datele filmului <b>"<%= titlu %>"</b> au fost actualizate cu succes în baza de date.</p>
        
        <a href="tabela_Filme.jsp" class="btn">Înapoi la Tabel</a>
    </div>
