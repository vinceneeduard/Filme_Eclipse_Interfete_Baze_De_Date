...
<head>
    ...
    <title>Tabela Categorii - Studio</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .btn-add { background: rgba(191, 90, 242, 0.15); color: var(--accent); border: 1px solid rgba(191, 90, 242, 0.3); }
        .btn-add:hover { background: var(--accent); color: white; box-shadow: 0 0 15px rgba(191, 90, 242, 0.4); }
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="page-header">
            <h1>Catalog Categorii</h1>
            <div class="controls">
                <a href="index.html" class="btn btn-home">🏠 Home</a>
                <a href="nou_Categorii.jsp" class="btn btn-add">+ Categorie Nouă</a>
            </div>
        </div>
